	...
	public function statistics() {
		...
		if(!$this->user) {
			...
			//If logged in Continue...	
				...
				$current_month_year = date("Y", strtotime("this month"));
				
				$minus_1_month = date("n", strtotime('first day of -1 months'));
				$minus_1_month_year = date("Y", strtotime('first day of -1 months'));
				
				$minus_2_month = date("n", strtotime('first day of -2 months'));
				$minus_2_month_year = date("Y", strtotime('first day of -2 months'));
				
				$minus_3_month = date("n", strtotime('first day of -3 months'));
				$minus_3_month_year = date("Y", strtotime('first day of -3 months'));

				$minus_4_month = date("n", strtotime('first day of -4 months'));
				$minus_4_month_year = date("Y", strtotime('first day of -4 months'));

				$minus_5_month = date("n", strtotime('first day of -5 months'));
				$minus_5_month_year = date("Y", strtotime('first day of -5 months'));

				$minus_6_month = date("n", strtotime('first day of -6 months'));
				$minus_6_month_year = date("Y", strtotime('first day of -6 months'));

				
				//Query the DB
				$current_month_q = "select * from reports WHERE (start_time LIKE '%$current_month/_/$current_month_year%') OR (start_time LIKE '%$current_month/__/$current_month_year%')";
				$current_month = DB::instance(DB_NAME)->select_rows($current_month_q);		
				
				$minus_1_month_q = "select * from reports WHERE (start_time LIKE '%$minus_1_month/_/$minus_1_month_year%') OR (start_time LIKE '%$minus_1_month/__/$minus_1_month_year%')";	
				$minus_1_month = DB::instance(DB_NAME)->select_rows($minus_1_month_q);		
				
				$minus_2_month_q = "select * from reports WHERE (start_time LIKE '%$minus_2_month/_/$minus_2_month_year%') OR (start_time LIKE '%$minus_2_month/__/$minus_2_month_year%')";	
				$minus_2_month = DB::instance(DB_NAME)->select_rows($minus_2_month_q);
				
				$minus_3_month_q = "select * from reports WHERE (start_time LIKE '%$minus_3_month/_/$minus_3_month_year%') OR (start_time LIKE '%$minus_3_month/__/$minus_3_month_year%')";	
				$minus_3_month = DB::instance(DB_NAME)->select_rows($minus_3_month_q);		
		
				$minus_4_month_q = "select * from reports WHERE (start_time LIKE '%$minus_4_month/_/$minus_4_month_year%') OR (start_time LIKE '%$minus_4_month/__/$minus_4_month_year%')";	
				$minus_4_month = DB::instance(DB_NAME)->select_rows($minus_4_month_q);		
		
				$minus_5_month_q = "select * from reports WHERE (start_time LIKE '%$minus_5_month/_/$minus_5_month_year%') OR (start_time LIKE '%$minus_5_month/__/$minus_5_month_year%')";	
				$minus_5_month = DB::instance(DB_NAME)->select_rows($minus_5_month_q);	
				
				$minus_6_month_q = "select * from reports WHERE (start_time LIKE '%$minus_6_month/_/$minus_6_month_year%') OR (start_time LIKE '%$minus_6_month/__/$minus_6_month_year%')";	
