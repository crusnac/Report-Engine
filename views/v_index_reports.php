			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<br />
						<p>
						The URL above contains your web application assessment vulnerability report. From a compliance perspective, all Critical, High and Medium level risks require remediation that are inline with Xerox standards and policies.</p>
					...
					<div class="modal-footer">
						<a href="http://infosec.corp.xerox.com/sr/srClose.hdp?sr_id=<?php print $report['request_number']; ?>&backToUrl=srIndex.hdp&backToPrompt=Service+Requests" target="_blank" class="btn btn-primary">Close Request #<?php print $report['request_number']; ?></a>
						<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					</div>
				</div>
				<!-- /.modal-content -->
