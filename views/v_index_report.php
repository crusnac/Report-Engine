	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>AXIS IMPORT NOTICE: Web application results import into AXIS on a nightly basis.  The results are uploded based upon the URL that was scanned. If this process is not successful, please open a ticket in CDP with Request-Action <a href="https://mksprod.office.xerox.com:7001/im;" target="_blank">https://mksprod.office.xerox.com:7001/im;</a> and assign it to the AXIS IT Service. A resources will be assigned to review the issue.
</p>
			</div>
			<div class="modal-footer">
						<a href="http://infosec.corp.xerox.com/sr/srClose.hdp?sr_id=<?php print $report[0]['request_number']; ?>&backToUrl=srIndex.hdp&backToPrompt=Service+Requests" target="_blank" class="btn btn-primary">Close Request #<?php print $report[0]['request_number']; ?></a>
						<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
			</div>
		</div>
		<!-- /.modal-content -->
